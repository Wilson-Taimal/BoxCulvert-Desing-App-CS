...
namespace BoxCulvert.Model
{
    public class ResultLosaInf
    {
        ...
        /// <summary>
        /// Msp: Momento en servico positivo de la sección _ [kN.cm]
        /// </summary>        
        public double Msp { get; set; }

        /// <summary>
        /// Msn: Momento en servicio negativo de la sección _ [kN.cm]
        /// </summary>        
        public double Msn { get; set; }
